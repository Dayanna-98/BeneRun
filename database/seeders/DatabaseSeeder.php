...
class DatabaseSeeder extends Seeder
{
    ...
    {
        $rows = [
        [$users['emma'], $competences['radio']],
        [$users['emma'], $competences['logistique']],
        [$users['alexandre'], $competences['accueil']],
        [$users['alexandre'], $competences['orientation']],
        [$users['sofian'], $competences['signalisation']],
        [$users['sofian'], $competences['ravitaillement']],
        [$users['marc'], $competences['ravitaillement']],
        [$users['marc'], $competences['logistique']],
        [$users['dayanna'], $competences['accueil']],
        [$users['dayanna'], $competences['premiers_secours']],
        [$users['leo'], $competences['signalisation']],
        [$users['leo'], $competences['radio']],
        [$users['nina'], $competences['ravitaillement']],
        [$users['zoe'], $competences['orientation']],   
        ];

        foreach ($rows as [$userId, $competenceId]) {
