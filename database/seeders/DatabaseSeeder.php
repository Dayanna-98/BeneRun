...
class DatabaseSeeder extends Seeder
{
    ...
    private function seedUsers(): array
    {
        $rows = [
            ...
            [
                'nom_utilisateur' => 'Meynier',
                'prenom_utilisateur' => 'Alexandre',
                'email' => 'alexandre.superadmin@benerun.test',
                'password' => Hash::make('Soleil12345'),
                'role_utilisateur' => 'superadmin',
            ],
            [
            ...
            [
                'nom_utilisateur' => 'Bianchi',
                'prenom_utilisateur' => 'Nina',
                'email' => 'nina.benevole@benerun.test',
                'password' => Hash::make('Soleil12345'),
                'role_utilisateur' => 'bénévole',
            ],
            [
                'nom_utilisateur' => 'Sutter',
                'prenom_utilisateur' => 'Zoe',
                'email' => 'zoe.benevole@benerun.test',
                'password' => Hash::make('Soleil12345'),
                'role_utilisateur' => 'bénévole',
            ],
        ];
